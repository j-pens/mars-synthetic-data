...
from mars.models.nerfacto import NerfactoModel as NerfactoModelWithLatentEmbeddingOption, NerfactoModelConfig
from mars.models.semantic_nerfw import SemanticNerfWModel as SemanticNerfWModelWithLatentEmbeddingOption
...
class SyntheticSceneGraphModel(Model):
    ...
    def get_background_outputs(self, ray_bundle: RayBundle):
        ...
        if self.config.use_interlevel_loss and self.training:
            if isinstance(self.background_model, NerfactoModelWithLatentEmbeddingOption) or isinstance(
                self.background_model, SemanticNerfWModelWithLatentEmbeddingOption
            ):
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        interlevel_bg = (
            ...
            if (
                isinstance(self.background_model, NerfactoModelWithLatentEmbeddingOption)
                or isinstance(self.background_model, SemanticNerfWModelWithLatentEmbeddingOption)
            )
        ...
        for class_id, type_id in enumerate(type_list):
            ...
            interlevel_obj = (
                ...
                if isinstance(model, NerfactoModelWithLatentEmbeddingOption) and self.config.use_interlevel_loss
                else 0.0
            )
