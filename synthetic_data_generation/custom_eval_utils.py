...
from mars.data.mars_pandaset_dataparser_rework import MarsPandasetParserRework
...
def eval_setup(
    ...
    # Hack: Insert reworked dataparser for PandaSet dataset
    if "pandaset" in config.experiment_name.lower():
        config.pipeline.datamanager.dataparser._target = MarsPandasetParserRework
